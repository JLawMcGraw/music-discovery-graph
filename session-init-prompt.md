...
- **Neovim Configuration**: My personal Neovim setup at `/home/gregg/.config/nvim`
- **lust-next**: Enhanced Lua testing framework
- **hooks-util**: Git hooks framework for pre-commit validation
- **nvim-toolkit**: Shared runtime utilities library
- **Neovim plugins**: Laravel Helper, Claude Code integration
- **Templates**: Base project, Neovim plugin and config templates
...
### CRITICAL: NEVER use the `cd` command in any work
...
### Always load these essential prompts:
...
### Follow these workflow guidelines:
...
5. ⏸️ Wait for me to specify the next task before proceeding
...
**File:** `/home/gregg/Projects/docs-projects/neovim-ecosystem-docs/metrics/prompt-metrics.md`
