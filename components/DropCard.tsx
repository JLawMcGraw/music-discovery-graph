...
export function DropCard({ drop, currentUserId, onSave, onUnsave }: DropCardProps) {
  ...
  return (
    <article className="bg-gray-800 rounded-lg p-6 space-y-4" aria-label={`Music drop: ${drop.track_name} by ${drop.artist_name}`}>
      {/* Header - User Info */}
      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <button
            ...
            aria-label={`Listen to ${drop.track_name} by ${drop.artist_name} on Spotify`}
          >
      ...
      <div className="flex items-center justify-between pt-4 border-t border-gray-700">
        ...
        {currentUserId && !isOwnDrop && (
          <button
            ...
            aria-label={isSaved ? `Unsave ${drop.track_name}` : `Save ${drop.track_name} to your collection`}
